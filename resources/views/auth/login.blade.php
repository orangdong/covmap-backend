    ...
    <div class="flex flex-col items-center h-full lg:flex-row ">
      ...
      <div
          ...
          <div class="w-full sm:w-7/12 md:w-8/12 lg:w-9/12 xl:w-7/12 mx-auto lg:mx-0">
            ...
            <h3 class="text-3xl font-semibold mb-3" style="color: #D8D7DF;">Silakan Masuk</h3>
            <p class="leading-7 text-sm mb-4" style="color: #737182;">Masuk dengan akun yang terdaftar<br>
              di website CovMap.</p>
            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="mt-3 text-right">
                <a href="{{ route('password.request') }}"
                  class="forgot-password-empty-3-6 text-sm italic">Lupa Password?</a>
              </div>
              <button type="submit"
            ...
            <p class="mt-8 text-center text-sm" style="color: #737182;">Belum punya akun? 
            <a href="{{ route('register') }}" class="font-medium hover:underline" style="color: #FFB341;">Daftar di sini</a></p>
          </div>
      </div>
    </div>                                                                  
    </div>
